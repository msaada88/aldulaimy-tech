...
/**
 * Building - Defines variables for a spatial representation of a building
...
public class Building 
{
    ...
    public void draw (Graphics g)
    {
        ...
        for (int i = 0; i < (height + width)/5 ; i++) //create randomly placed windows
        {
            g.fillRect (gen.nextInt (width-8) + x + 4, gen.nextInt (height-8) + y + 4, 1, 1);
        }
    }    
}